...
本节介绍如何管理 RKE 模板和修订版。您可以在**全局**视图下的**工具 > RKE 集群模板**中创建，共享，更新和删除模板。
...
如果您具有**创建 RKE 模板**权限，则可以**创建 RKE 模板**，该权限可以[由系统管理员配置](/docs/admin-settings/rke-templates/creator-permissions/_index)。
...
您无法编辑单个修订版。由于您无法编辑模板的各个修订，因此为了防止使用这些修订版，您可以[禁用](#禁用模板修订版)它。
