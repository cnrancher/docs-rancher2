...
因为 Rancher 高可用安装需要 Kubernetes 集群，所以需要使用[Rancher Kubernetes Engine](https://rancher.com/docs/rke/latest/en/)（RKE）来部署 Kubernetes 集群。在安装 Kubernetes 之前，您需要先[安装 RKE](https://rancher.com/docs/rke/latest/en/installation/)，并且创建一个 RKE 配置文件。
...
如果您在使 Helm 2 离线安装 Rancher 的过程中碰到问题，请查看[问题排查](/docs/installation/options/troubleshooting/_index)。

## 后续操作

[安装 Rancher](/docs/installation/options/air-gap-helm2/install-rancher/_index)
