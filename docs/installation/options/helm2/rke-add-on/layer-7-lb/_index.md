---
title: 可 SSL 终止的 7 层负载均衡器（HTTPS）
...
- [配置 Amazon ALB](/docs/installation/options/rke-add-on/layer-7-lb/alb/_index)
- [配置 NGINX](/docs/installation/options/rke-add-on/layer-7-lb/nginx/_index)
...
1.  使用您的 Linux 主机信息更新配置模板中的 `nodes` 域。
    ...
    > **注意：**
    >
    > 使用 RHEL / CentOS 时，由于https://bugzilla.redhat.com/show_bug.cgi?id=1527565 导致 SSH 用户无法成为 root 用户。有关 RHEL / CentOS 的特定要求，请参阅[操作系统](https://rancher.com/docs/rke/latest/en/installation/os#redhat-enterprise-linux-rhel-centos)要求。
