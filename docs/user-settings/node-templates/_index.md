...
- 创建节点池集群的同时，创建节点模板，详情请参考[创建带有节点池的集群](/docs/cluster-provisioning/rke-clusters/node-pools/_index)。
...
**结果：**成功克隆了一个节点模板，完成了该模板的配置更新。您可以使用这个模板[创建支持节点池的集群](/docs/cluster-provisioning/rke-clusters/node-pools/_index)。
