---
title: 版本说明 - v2.4.0
description: Rancher 2.4.0 版本于 2020 年 3 月 31 日发布。本文介绍了 Rancher 2.4.0 相较上一版本（2.3）的功能优化、新增的实验性功能、问题修复和已知问题。
keywords:
  - rancher 2.0中文文档
  - rancher 2.x 中文文档
  - rancher中文
...
Rancher 2.4.0 版本于 2020 年 3 月 31 日发布。本文介绍了 Rancher 2.4.0 相较上一版本（2.3）的功能优化、新增的实验性功能、问题修复和已知问题。点击[这里](https://github.com/rancher/rancher/releases/tag/v2.4.0)查看英文版版本说明。
:::important 提示
我们在 v2.4.0 中发了这个[问题](https://forums.rancher.com/t/rancher-bug-advisory-in-v2-4-0-rancher-issue-26339-kubelets-constantly-restarting-in-user-clusters/17005/2)，已经在 v2.4.2 中进行了修复。
:::
