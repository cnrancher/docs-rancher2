...
- **默认 Kubernetes 版本为 1.16**
  ...
  - Kubernetes 1.16 被设置为了默认版本。在任何时候，如果你要升级 Kubernetes 版本，请务必查看 Kubernetes 官方到版本说明，从而了解 Kubernetes 版本中的重大变化。Kubernetes 1.16 中移除了一些被弃用的 API，具体请查看 Kubernetes 1.16 的版本说明。
...
- **支持从现有 RKE 集群导出 RKE 集群模版 [[#22992](https://github.com/rancher/rancher/issues/22992)]** - 如果之前你已经通过 RKE 创建了一个集群，现在你可以把这个集群导出为集群模版。然后，你可以开始通过这个 RKE 模版来更新这个集群。
