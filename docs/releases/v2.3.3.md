---
title: 版本说明 - v2.3.3
description: Rancher 2.3.3 版本于 2019 年 11 月 28 日发布。本文介绍了 Rancher 2.3.3 相较上一版本（2.3.2）的功能优化、新增的实验性功能和已知问题。
...
Rancher 2.3.3 版本于 2019 年 11 月 28 日发布。本文介绍了 Rancher 2.3.3 相较上一版本（2.3.2）的功能优化、新增的实验性功能和已知问题。点击[这里](https://github.com/rancher/rancher/releases/tag/v2.3.3)查看英文版版本说明。
