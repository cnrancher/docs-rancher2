...
Rancher 2.3.4 版本于 2020 年 1 月 17 日发布。本文介绍了 Rancher 2.3.4 相较上一版本（2.3.3）的重大改动、新增的实验性功能、已修复的问题和已知问题。点击[这里](https://github.com/rancher/rancher/releases/tag/v2.3.4)查看英文版版本说明。
