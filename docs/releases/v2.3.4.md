---
title: 版本说明 - v2.3.4
description: Rancher 2.3.4 版本于 2020 年 1 月 17 日发布。本文介绍了 Rancher 2.3.4 相较上一版本（2.3.3）的功能优化和新增的实验性功能。
keywords:
  - rancher 2.0中文文档
  - rancher 2.x 中文文档
  - rancher中文
...
RRancher 2.3.4 版本于 2020 年 1 月 17 日发布。本文介绍了 Rancher 2.3.4 相较上一版本（2.3.3）的功能优化、新增的实验性功能和问题修复。点击[这里](https://github.com/rancher/rancher/releases/tag/v2.3.4)查看英文版版本说明。
