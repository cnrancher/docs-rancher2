...
description: Rancher 2.3.6 版本于 2020 年 3 月 31 日发布。本文介绍了 Rancher 2.3.6 相较上一版本（2.3.5）的功能优化、新增的实验性功能、问题修复和已知问题。
keywords:
  - rancher 2.0中文文档
  - rancher 2.x 中文文档
  - rancher中文
...
Rancher 2.3.6 版本于 2020 年 3 月 31 日发布。本文介绍了 Rancher 2.3.6 相较上一版本（2.3.5）的功能优化、新增的实验性功能、问题修复和已知问题。点击[这里](https://github.com/rancher/rancher/releases/tag/v2.3.6)查看英文版版本说明。
