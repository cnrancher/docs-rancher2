...
1. 选择一个日志服务，然后输入配置。有关详细的配置，请参考特定的服务。Rancher 支持与以下日志服务集成：
   ...
   - [Elasticsearch 配置指南](/docs/cluster-admin/tools/logging/elasticsearch/_index)
   - [Splunk 配置指南](/docs/cluster-admin/tools/logging/splunk/_index)
   - [Kafka 配置指南](/docs/cluster-admin/tools/logging/kafka/_index)
   - [Syslog 配置指南](/docs/cluster-admin/tools/logging/syslog/_index)
   - [Fluentd 配置指南](/docs/cluster-admin/tools/logging/fluentd/_index)
