...
1. From the cluster where you configured vSphere storage, begin creating a workload as you would in [Deploying Workloads](/docs/k8s-in-rancher/workloads/deploy-workloads/).
...
6. Open the context menu next to the Pod in the _Running_ state.
