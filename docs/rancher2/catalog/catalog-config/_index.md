...
任何用户都可以[添加自定义应用商店](/docs/rancher2/catalog/creating-apps/_index)到 Rancher 中。除了应用商店的内容外，用户还必须确保能够将商店添加到 Rancher 中。
...
在[添加应用商店](/docs/rancher2/catalog/adding-catalogs/_index)到 Rancher 时，用户必须提供下列信息：
...
1. [添加应用商店](/docs/rancher2/catalog/adding-catalogs/_index)时，选中**使用私有应用商店**复选框。
...
2. [添加应用商店](/docs/rancher2/catalog/adding-catalogs/_index)时，选中`使用私有应用商店`复选框。
