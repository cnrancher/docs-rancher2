...
完成[在 Microsoft AD FS 中配置 Rancher 对接](/docs/rancher2/admin-settings/authentication/microsoft-adfs/microsoft-adfs-setup/)后，将您的 AD FS 信息输入 Rancher，以允许 Rancher 通过 AD FS 进行身份验证。
