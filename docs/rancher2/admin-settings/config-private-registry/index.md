...
有关在 Rancher 的安装过程中使用命令行选项设置私有镜像仓库的说明，请参阅[单节点离线安装](/docs/rancher2/installation/other-installation-methods/air-gap/)或[高可用离线安装](/docs/rancher2/installation/other-installation-methods/air-gap/)说明。
