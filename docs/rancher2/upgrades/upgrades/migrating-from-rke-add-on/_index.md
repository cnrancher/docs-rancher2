...
> **注意：** 删除这些 Kubernetes 组件不会影响 Rancher 的配置或数据库，但是在进行任何维护后，最好事先创建数据备份。有关详细信息，请参见[备份高可用 Rancher](/docs/rancher2/backups/backups/ha-backups/_index)。
...
- [3 - 初始化 Helm](/docs/rancher2/installation/options/helm2/helm-init/_index)
- [4 - 安装 Rancher](/docs/rancher2/installation/options/helm2/helm-rancher/_index)
