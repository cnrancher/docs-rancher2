...
1. 选择一个日志服务，输入配置参数。每个日志服务需要输入的参数都不一样，请参考每个日志服务的操作文档输入参数。Rancher 支持的日志服务有以下几种：
   ...
   - [Elasticsearch](/docs/rancher2/cluster-admin/tools/cluster-logging/elasticsearch/_index)
   - [Splunk](/docs/rancher2/cluster-admin/tools/cluster-logging/splunk/_index)
   - [Kafka](/docs/rancher2/cluster-admin/tools/cluster-logging/kafka/_index)
   - [Syslog](/docs/rancher2/cluster-admin/tools/cluster-logging/syslog/_index)
   - [Fluentd](/docs/rancher2/cluster-admin/tools/cluster-logging/fluentd/_index)
