...
如果您需要了解 Rancher 与日志服务或工具集成的工作原理，请参考[集群管理员章节](/docs/rancher2/project-admin/tools/project-logging/)相关文档。
...
只有[管理员](/docs/rancher2/admin-settings/rbac/global-permissions/)、[集群所有者或集群成员](/docs/rancher2/admin-settings/rbac/cluster-project-roles/)或[项目所有者](/docs/rancher2/admin-settings/rbac/cluster-project-roles/)有权限配置 Rancher 的日志功能。
...
- [集群日志](/docs/rancher2/project-admin/tools/project-logging/)记录了包括集群中每一个项目，每一个 Pod 的活动。[RKE 集群](/docs/rancher2/cluster-provisioning/rke-clusters/)开启了日志功能后，会记录 Kubernetes 系统组件的活动。
...
1. 选择一个日志服务，输入配置参数。每个日志服务需要输入的参数都不一样，请参考每个日志服务的操作文档输入参数。Rancher 支持的日志服务有以下几种：
   ...
   - [Elasticsearch](/docs/rancher2/cluster-admin/tools/cluster-logging/elasticsearch/)
   - [Splunk](/docs/rancher2/cluster-admin/tools/cluster-logging/splunk/)
   - [Kafka](/docs/rancher2/cluster-admin/tools/cluster-logging/kafka/)
   - [Syslog](/docs/rancher2/cluster-admin/tools/cluster-logging/syslog/)
   - [Fluentd](/docs/rancher2/cluster-admin/tools/cluster-logging/fluentd/)
