...
有关安装选项的更多信息，请参考[本页](/docs/rancher2/installation/_index)。
...
关于设置 MySQL 数据库的一种方法的例子，请参考这个[教程](/docs/rancher2/installation/resources/k8s-tutorials/infrastructure-tutorials/rds/_index)，在 Amazon 的 RDS 服务上设置 MySQL。
...
关于如何设置 NGINX 负载均衡器的例子，请参考[本页](/docs/rancher2/installation/resources/k8s-tutorials/infrastructure-tutorials/nginx/_index)
