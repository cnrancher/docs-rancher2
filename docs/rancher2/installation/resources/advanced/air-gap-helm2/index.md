...
- [1、准备节点](/docs/rancher2/installation/resources/advanced/air-gap-helm2/prepare-nodes/)
- [2、同步镜像到私有镜像库](/docs/rancher2/installation/resources/advanced/air-gap-helm2/populate-private-registry/)
- [3、安装 Kubernetes 集群](/docs/rancher2/installation/resources/advanced/air-gap-helm2/launch-kubernetes/)
- [4、安装 Rancher](/docs/rancher2/installation/resources/advanced/air-gap-helm2/install-rancher/)

## 后续步骤

[准备节点](/docs/rancher2/installation/resources/advanced/air-gap-helm2/prepare-nodes/)
