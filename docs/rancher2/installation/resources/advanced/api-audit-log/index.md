...
- [Rancher 单节点](/docs/rancher2/installation/other-installation-methods/single-node-docker/)

- [Rancher 高可用](/docs/rancher2/installation/resources/chart-options/)
...
| 参数                                  | 描述                                                                                                                                                                                                                                                        |
| ------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <a id="audit-level"></a>`AUDIT_LEVEL` | `0` - 禁用审计日志 (默认设置)`1` - 仅记录事件元数据 `2` - 记录事件元数据及请求内容 <br />`3` - 记录事件元数据、请求内容及响应内容。请求/响应对的每个日志事务使用相同的`auditID`值 有关显示每个等级设置记录的具体内容，请参阅[审计日志级别](#审计日志级别)。 |
...
详情请参考[Rancher 工具 - 日志](/docs/rancher2/project-admin/tools/project-logging/)。
