...
对于无法访问互联网的环境，请查看[Helm - 离线安装](/docs/rancher2/installation/resources/advanced/air-gap-helm2/install-rancher/_index)获取更多安装信息。

请参阅[Helm 版本要求](/docs/rancher2/installation/resources/helm-version/_index)，选择安装 Rancher 的 Helm 版本。

> **提示：** 安装指南基于 Helm 2 写作，如果您在使用 Helm 3，请参照[此说明](/docs/rancher2/installation/resources/advanced/helm2/helm-rancher/_index)。
...
请查看[问题排查](/docs/rancher2/installation/resources/advanced/helm2/helm-init/troubleshooting/_index)。
