...
请使用 Rancher helm chart 将 Rancher 安装在 Kubernetes 集群上。有关详细信息，请参见[Helm 版本要求](/docs/rancher2/installation/resources/helm-version/)。
...
仔细检查[所需端口](/docs/rancher2/cluster-provisioning/node-requirements/)是否已在主机防火墙或 VPC 安全组中打开。
...
如果在输出中看到错误，则表示在测试的主机之间未打开 Overlay 网络的[所需端口](/docs/rancher2/cluster-provisioning/node-requirements/)。
