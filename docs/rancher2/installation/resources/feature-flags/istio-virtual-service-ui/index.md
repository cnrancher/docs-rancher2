...
> **先决条件：** 打开此功能不会启用 Istio。集群管理员需要[为集群启用 Istio](/docs/rancher2/cluster-admin/tools/istio/setup/)才能使用该功能。

要启用或禁用此功能，请参阅[关于启用实验性功能的主页](/docs/rancher2/installation/resources/feature-flags/)。
