...
> 这些说明已针对 Helm 3 进行了更新。如果您仍在使用 Helm 2，请参阅[以下说明](/docs/rancher2/installation/resources/upgrading-cert-manager/helm-2-instructions/)。
...
1. 按照指南[准备私有镜像仓库](/docs/rancher2/installation/other-installation-methods/air-gap/populate-private-registry/)准备升级所需的镜像。
