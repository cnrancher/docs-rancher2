...
按照[本页](/docs/rancher2/installation/resources/update-ca-cert/)上的步骤更新 Rancher[高可用性 Kubernetes 安装](/docs/rancher2/installation/install-rancher-on-k8s/)中的入口的 SSL 证书，或从默认的自签名证书切换到自定义证书。
