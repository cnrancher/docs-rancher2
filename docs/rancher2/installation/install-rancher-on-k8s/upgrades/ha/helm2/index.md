...
:::important 重要
在发布 Helm 3 之后，[Rancher 高可用升级指南](../)已更新为使用 Helm 3 的升级指南。
...
要升级 Kubernetes 集群中的组件，[Kubernetes 服务](/docs/rke/config-options/services/)或[add-ons](/docs/rke/config-options/add-ons/)，请参阅[RKE 的升级文档](/docs/rke/upgrades/)，Rancher Kubernetes Engine。
...
为运行 Rancher Server 的 Kubernetes 集群[创建快照](/docs/rancher2/backups/backup/ha-backups/)。
...
如果升级异常，可以通过使用升级之前拍摄的快照，恢复集群。有关更多信息，请参阅[高可用回滚](/docs/rancher2/installation/install-rancher-on-k8s/rollbacks/)。
