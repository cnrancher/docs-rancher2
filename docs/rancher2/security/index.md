...
安全是 Rancher 全部功能的基础。Rancher 集成了全部的主流认证工具和服务，并且提供了企业级的[RBAC 能力](/docs/rancher2/admin-settings/rbac/)，这些都可以让您的 Kubernetes 集群更安全。
...
更多详情，请参阅[安全扫描](/docs/rancher2/security/security-scan/)文档。

## Rancher 安全加固指南

Rancher 的安全加固指南是根据 CIS（互联网安全中心）发布的[CIS Kubernetes 安全标准](https://www.cisecurity.org/benchmark/kubernetes/)中的最佳实践来建立的。
...
Rancher 致力于向社区披露我们产品的安全问题。Rancher 将对修复的问题通过发布 CVEs(通用漏洞披露，Common Vulnerabilities and Exposures)通知社区，详情请查看[安全漏洞和解决方法](/docs/rancher2/security/cve/)。

## 安全建议和最佳实践

我们的[最佳实践建议](/docs/rancher2/best-practices/management/)包含了基本的提升 Rancher 安全的建议。
