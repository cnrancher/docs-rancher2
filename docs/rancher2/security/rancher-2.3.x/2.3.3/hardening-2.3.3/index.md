...
有关如果根据官方 CIS 基准评估集群的更多详细信息，请参阅[CIS Benchmark Rancher 自测指南 - Rancher v2.3.3](/docs/rancher2/security/rancher-2.3.x/2.3.3/benchmark-2.3.3/)。
...
Follow the steps as documented in [1.4.12](/docs/rancher2/security/rancher-2.3.x/2.3.3/hardening-2.3.3/) remediation.
