...
在 Rancher 的新版本发布之前，将会对 Kubernetes 的最新次要版本进行测试，以确保兼容性。关于在每个 Rancher 版本上测试了哪些版本的 Kubernetes 的详细信息，请参考[支持维护条款](https://rancher.com/support-maintenance-terms/all-supported-versions/rancher-v2.4.17/)。
...
> **先决条件：**
>
> - 以下选项仅适用于 [RKE 集群](/docs/rancher2/cluster-provisioning/rke-clusters/)和[导入的 K3s Kubernetes 集群](/docs/rancher2/cluster-provisioning/imported-clusters/)。
> - 升级 Kubernetes 之前，请[备份您的集群](/docs/rancher2/backups/)。
...
- [备份集群](/docs/rancher2/cluster-admin/backing-up-etcd/)
- [从备份恢复集群](/docs/rancher2/cluster-admin/restoring-etcd/)
...
1. 选择安全或激进的驱散选项。有关每个选项的更多信息，请参考[本节](/docs/rancher2/cluster-admin/nodes/)。
