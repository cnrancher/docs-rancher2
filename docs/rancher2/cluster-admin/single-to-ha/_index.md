...
1. 根据文档[示例配置](/docs/rancher2/installation_new/k8s-install/kubernetes-rke/_index#2、创建-rke-配置文件) 创建 RKE 配置文件。
...
1. 根据[自签名 ssl 证书](/docs/rancher2/installation_new/options/self-signed-ssl/_index)文档创建自签名证书或者配置权威证书；
2. 根据[安装文档](/docs/rancher2/installation_new/k8s-install/_index)进行 Rancher HA 安装；
