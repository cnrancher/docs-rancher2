...
Rancher 提供了许多 Kubernetes 中没有的集群工具，帮助您的 DevOps 运作。Rancher 可以与外部服务集成，以帮助您的集群更有效地运行。集群工具分为：告警、通知、日志、监控、Istio 服务网格和 OPA Gatekeeper，详情请参考 [集群工具](/docs/cluster-admin/tools/_index)。
