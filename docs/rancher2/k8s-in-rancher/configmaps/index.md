...
1. 单击 **保存**。
   ...
   > **注意：** 不要使用配置映射去存储敏感数据 [使用一个密文](/docs/rancher2/k8s-in-rancher/secrets/)。
   >
...
有关 ConfigMap 添加到工作负载的更多信息，请参见[部署工作负载](/docs/rancher2/k8s-in-rancher/workloads/deploy-workloads/)。
