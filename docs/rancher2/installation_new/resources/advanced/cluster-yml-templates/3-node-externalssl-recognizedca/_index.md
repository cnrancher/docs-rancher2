...
本模板旨在用于 RKE 插件安装，只支持到 Rancher v2.0.8。如果您要安装更新的 Rancher 版本，请使用 Rancher Helm chart。有关详细信息，请参阅[Kubernetes 安装-安装大纲](/docs/rancher2/installation_new/install-rancher-on-k8s/_index)。
