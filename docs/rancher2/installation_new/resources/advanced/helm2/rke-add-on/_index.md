...
- [使用（TCP/4 层）外部负 rancher2/载均衡器安装高可用 Rancher](/docs/rancher2/installation_new/options/rke-add-on/layer-4-lb/_index)
- [使用（HTTPS/7 层）外部负载均衡器安装高可用 Rancher](/docs/rancher2/installation_new/options/rke-add-on/layer-7-lb/_index)
- [为高可用 Rancher 配置 HTTP Proxy](/docs/rancher2/installation_new/options/rke-add-on/proxy/_index)
- [RKE add-on 安装问题排查](/docs/rancher2/installation_new/options/rke-add-on/troubleshooting/_index)
