...
- [helm](https://docs.helm.sh/using_helm/#installing-helm) - Kubernetes 包管理工具。可参考[Helm 版本要求](/docs/rancher2/installation_new/options/helm-version/_index)来选择合适的 Helm 版本安装 Rancher。

## 安装大纲

- [创建节点和负载均衡](/docs/rancher2/installation_new/options/helm2/create-nodes-lb/_index)
- [使用 rke 安装 Kubernetes](/docs/rancher2/installation_new/options/helm2/kubernetes-rke/_index)
- [初始化 Helm (tiller)](/docs/rancher2/installation_new/options/helm2/helm-init/_index)
- [安装 Rancher](/docs/rancher2/installation_new/options/helm2/helm-rancher/_index)
...
[RKE add-on 安装](/docs/rancher2/installation_new/options/rke-add-on/_index/)

> **重要: RKE add-on 安装方式仅支持到 Rancher v2.0.8**
>
> 请在 Kubernetes 集群中使用 Rancher Helm Chart 来安装 Rancher。更多内容，请参考[Rancher 高可用安装](/docs/rancher2/installation_new/options/helm2/_index)。
>
