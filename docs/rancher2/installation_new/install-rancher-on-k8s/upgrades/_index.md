...
- [升级单节点 Rancher](/docs/rancher2/installation_new/upgrades-rollbacks/upgrades/single-node/_index)
- [升级高可用 Rancher](/docs/rancher2/installation_new/upgrades-rollbacks/upgrades/ha/_index)
...
| 从 v2.0.7 或更早版本升级  | Rancher 引入了 `System` 项目，这是一个自动创建的项目，用于存放 Kubernetes 需要操作的重要命名空间。在升级到 v2.0.7+ 的过程中，Rancher 希望从所有项目中移出这些命名空间。在开始升级之前，请检查这些系统命名空间，确保它们不在任何项目中，从而[防止集群网络问题](/docs/rancher2/installation_new/upgrades-rollbacks/upgrades/namespace-migration/_index)。              |
...
如果您当前正在使用 RKE Add-on 安装方法，请参阅[从 RKE Add-on 安装迁移](/docs/rancher2/installation_new/upgrades-rollbacks/upgrades/migrating-from-rke-add-on/_index)了解有关如何迁移到使用 helm chart 安装 Rancher 高可用。
