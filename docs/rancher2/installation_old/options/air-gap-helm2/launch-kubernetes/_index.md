...
使用您创建的[3 个节点](/docs/rancher2/installation/options/air-gap-helm2/prepare-nodes/_index)的 IP 地址或 DNS 名称，替换下面的代码示例中的值。
...
如果您在使 Helm 2 离线安装 Rancher 的过程中碰到问题，请查看[问题排查](/docs/rancher2/installation/options/troubleshooting/_index)。

## 后续操作

[安装 Rancher](/docs/rancher2/installation/options/air-gap-helm2/install-rancher/_index)
