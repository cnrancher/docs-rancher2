...
Rancher 2.4.4 版本于 2020 年 6 月 2 日发布。本文介绍了 Rancher 2.4.4 相较上一版本（2.4.3）的安全漏洞处理、新增的实验性功能、已修复的问题和已知问题。点击[这里](https://github.com/rancher/rancher/releases/tag/v2.4.4)查看英文版版本说明。
