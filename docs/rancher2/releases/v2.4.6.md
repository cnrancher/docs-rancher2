...
Rancher 2.4.6 版本于 2020 年 8 月 27 日发布。本文介绍了 Rancher 2.4.6 相较上一版本（2.4.5）的重大改动、已修复的 Kubernetes 安全漏洞、已修复的问题和已知问题。点击[这里](https://github.com/rancher/rancher/releases/tag/v2.4.6)查看英文版版本说明。
...
- [1.18.6](https://github.com/rancher/hyperkube/releases/tag/v1.18.6-rancher2)(默认版本）
- [1.17.9](https://github.com/rancher/hyperkube/releases/tag/v1.17.9-rancher2)
