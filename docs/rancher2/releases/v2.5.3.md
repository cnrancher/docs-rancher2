...
Rancher 2.5.3 版本于 2020 年 12 月 1 日发布。点击[这里](https://github.com/rancher/rancher/releases/tag/v2.5.3)查看英文版版本说明。
...
- 修正了一个错误，当在仪表板中添加 http/ssh 凭证时，Fleet 中的私有 Git repo 不起作用。
...
- [1.19.3](https://github.com/rancher/hyperkube/releases/tag/v1.19.3-rancher2)(默认版本）
- [1.18.10](https://github.com/rancher/hyperkube/releases/tag/1.18.10-rancher1)
- [1.17.13](https://github.com/rancher/hyperkube/releases/tag/1.17.13-rancher1)
