...
创建[自定义集群](/docs/rancher2/cluster-provisioning/rke-clusters/custom-nodes/)时，必须手动将 IAM 角色附加到实例。
...
创建 [Amazon EC2 集群](/docs/rancher2/cluster-provisioning/rke-clusters/node-pools/ec2/)时，Rancher 将为创建的节点自动设置`ClusterID`。其他资源仍然需要手动标记。
