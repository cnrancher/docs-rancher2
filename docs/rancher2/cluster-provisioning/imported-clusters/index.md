...
- 通过基于角色的访问控制[管理集群访问](/docs/rancher2/admin-settings/rbac/cluster-project-roles/)。
- 启用[监控](/docs/rancher2/cluster-admin/tools/cluster-monitoring/)和[日志](/docs/rancher2/project-admin/tools/project-logging/)
- 启用[Istio](/docs/rancher2/cluster-admin/tools/istio/)
- 启用[OPA Gatekeeper](/docs/rancher2/cluster-admin/tools/opa-gatekeeper//)
- 使用[流水线](/docs/rancher2/project-admin/pipelines/)
- 配置[告警](/docs/rancher2/cluster-admin/tools/cluster-alerts/)和[通知](/docs/rancher2/cluster-admin/tools/notifiers/)
- 管理[项目](/docs/rancher2/project-admin/)和[工作负载](/docs/rancher2/k8s-in-rancher/workloads/)

导入 K3s 集群后，集群所有者还可以[从 Rancher UI 升级 Kubernetes 版本](/docs/rancher2/cluster-admin/upgrading-kubernetes/)。
...
您现在可以将 K3s Kubernetes 集群导入 Rancher。[K3s](/docs/k3s/)是一个轻量级的，经过一致性认证的 Kubernetes 发行版。您还可以通过在 Rancher UI 中编辑 K3s 集群来升级 Kubernetes。
