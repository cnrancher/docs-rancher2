...
- 启用[监控](/docs/rancher2/cluster-admin/tools/monitoring/_index)和[日志](/docs/rancher2/cluster-admin/tools/logging/_index)
...
- 配置[告警](/docs/rancher2/cluster-admin/tools/alerts/_index)和[通知](/docs/rancher2/cluster-admin/tools/notifiers/_index)
