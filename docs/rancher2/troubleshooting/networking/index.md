...
仔细检查是否所有[所需的端口](/docs/rancher2/cluster-provisioning/node-requirements/)在主机防火墙中打开。与其他所有必需的 TCP 端口相比，Overlay 网络使用 UDP。
...
如果您在输出中看到错误，则表示用于 Overlay 网络的[所需的端口](/docs/rancher2/cluster-provisioning/node-requirements/)在指示的主机之间没有打开。
