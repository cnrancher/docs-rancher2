...
description: 本章 FAQ 将回答用户关于 Rancher v2.x 常见的问题，我们将保持持续更新。关于常见的技术问题，请参阅[常见的技术问题](/docs/rancher2/faq/technical/)。
keywords:
  - rancher
  - rancher中文
  - rancher中文文档
...
关于常见的技术问题，请参阅[常见的技术问题](/docs/rancher2/faq/technical/)。
...
自 Rancher 2.3.0 起，我们支持在 Windows Server 1809 服务器上运行 Windows 容器。关于如何创建一个包含 Windows Workder 节点的集群，请参见[配置自定义 Windows 集群](/docs/rancher2/cluster-provisioning/rke-clusters/windows-clusters/)章节。
