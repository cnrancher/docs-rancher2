...
> **注意:** 对于[添加服务](/docs/rancher1/infrastructure/cattle/adding-services/)/[添加负载均衡](/docs/rancher1/infrastructure/cattle/adding-load-balancers/)，如果您在数量那里选择了 **总是在每台主机上运行一个此容器的实例**，则只有主机标签将显示为可能的字段。
