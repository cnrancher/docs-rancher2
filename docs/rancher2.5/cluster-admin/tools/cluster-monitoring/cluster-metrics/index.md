...
[_获取具体的指标表达式_](/docs/rancher2.5/cluster-admin/tools/cluster-monitoring/expression/)

### Etcd 指标

> **注意：** 仅支持通过 [Rancher 安装的 Kubernetes 集群](/docs/rancher2/cluster-provisioning/rke-clusters/)。
...
Rancher 日志指标可以展示日志服务相关组件的操作情况，前提是您需要[为 Rancher 启用日志服务](/docs/rancher2/project-admin/tools/project-logging/)。
