...
有关触发内置告警的详细信息，请参阅[内置告警](/docs/rancher2.5/cluster-admin/tools/cluster-alerts/default-alerts/_index)。
...
> **前提：** 在收到集群告警之前，您必须[添加接收者](/docs/rancher2.5/cluster-admin/tools/notifiers/_index)。
...
1. 最后，选择[接收者](/docs/rancher2.5/cluster-admin/tools/notifiers/_index)。
