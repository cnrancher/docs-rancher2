...
设置持久化存储设备的步骤将根据基础设施而有所不同。我们提供了一些例子来展示如何进行存储设置：[NFS](/docs/rancher2.5/cluster-admin/volumes-and-storage/examples/nfs/)，[vSphere](/docs/rancher2.5/cluster-admin/volumes-and-storage/examples/vsphere/) 以及[亚马逊 EBS](/docs/rancher2.5/cluster-admin/volumes-and-storage/examples/ebs/)。
