...
- [集群所有者](/docs/rancher2.5/admin-settings/rbac/cluster-project-roles/_index)可以设置[集群级别](/docs/rancher2.5/monitoring-alerting/2.0-2.4/cluster-alerts/_index)的告警。
- [项目所有者](/docs/rancher2.5/admin-settings/rbac/cluster-project-roles/_index)可以设置[项目级别](/docs/rancher2.5/project-admin/tools/alerts/_index)的告警。
