...
确保您的节点满足[安装要求](/docs/rancher2.5/installation_new/requirements/_index)。
...
- [helm](https://docs.helm.sh/using_helm/#installing-helm) - Kubernetes 的软件包管理。请参阅[Helm 版本要求](/docs/rancher2.5/installation_new/resources/helm-version/_index)以选择 Helm 的版本来安装 Rancher。
...
在[需求](/docs/rancher2.5/installation_new/requirements/_index)中查看每个集群节点的硬件和软件需求。
...
[同步镜像到私有镜像仓库](/docs/rancher2.5/installation_new/resources/advanced/air-gap-helm2/populate-private-registry/_index)
