...
使用您创建的[3 个节点](/docs/rancher2.5/installation_new/other-installation-methods/air-gap/prepare-nodes/_index)的 IP 地址或 DNS 名称，替换下面的代码示例中的值。
...
请查看[问题排查](/docs/rancher2.5/installation_new/other-installation-methods/troubleshooting/_index)页面，获取常见问题和解决方法。

## 后续操作

[安装 Rancher](/docs/rancher2.5/installation_new/other-installation-methods/air-gap/install-rancher/_index)
