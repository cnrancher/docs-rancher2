...
这些说明假设你已经[创建了一个备份](/docs/rancher2.5/backups/back-up-rancher/)，并且已经安装了将在其中部署 Rancher 的新 Kubernetes 集群。
...
- [RKE Kubernetes 安装文档](/docs/rancher2.5/installation/)
- [K3s Kubernetes 安装文档](/docs/k3s/installation/)
...
按照文档中关于在 Kubernetes 上安装 cert-manager 的步骤[安装 cert-manager](/docs/rancher2.5/installation/install-rancher-on-k8s/#5-install-cert-manager)。
