...
- [Rancher 单节点](/docs/rancher2.5/installation/other-installation-methods/single-node-docker/)

- [Rancher 高可用](/docs/rancher2.5/installation/resources/chart-options/)
...
详情请参考[Rancher 工具 - 日志](/docs/rancher2.5/logging/migrating/)。
