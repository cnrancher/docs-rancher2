...
| 参数                     | 默认值                                                | 描述                                                                                                                    |
| ------------------------ | ----------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------- |
| `addLocal`               | "auto"                                                | **_string_** - 让 Rancher 检测并[导入本地集群](/docs/rancher2.5/installation/resources/chart-options/)            |
...
| `auditLog.level`         | 0                                                     | **_int_** - 设置[API 审核日志级别](/docs/rancher2.5/installation/resources/advanced/api-audit-log//)。0 为关闭。[0-3] |
