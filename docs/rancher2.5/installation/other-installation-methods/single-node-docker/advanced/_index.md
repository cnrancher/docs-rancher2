...
安装 Rancher 时，您可以启用以下几个[高级选项](/docs/rancher2.5/installation/resources/advanced/_index)：
...
参考[TLS 配置](/docs/rancher2.5/installation/resources/tls-settings/_index)查看更多信息和参数。
