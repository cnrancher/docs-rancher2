...
你需要在主机上有几个命令行工具，你可以通过 SSH 访问 Linux 节点以创建集群并与集群交互：

- [RKE CLI binary](/docs/rke/installation/)
...
接下来，创建一个描述 RKE 集群的 YAML 文件。确保节点的 IP 地址和 SSH 用户名是正确的。关于集群 YAML 的更多信息，请查看[RKE 文档](/docs/rke/example-yamls/)。
...
请参见[故障排查](/docs/rancher2.5/installation/other-installation-methods/troubleshooting/)页面。
