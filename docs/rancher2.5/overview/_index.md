...
- **应用商店管理：** Rancher 可以使用[Helm Charts 应用商店](/docs/rancher2.5/helm-charts/_index)重复部署应用。
...
- **日志：** Rancher 可以跟多种主流日志工具集成，您可以设置 [Rancher 日志](/docs/rancher2.5/logging/migrating/_index)。
- **监控：** 使用 Rancher，您可以通过 Prometheus 监控集群节点、Kubernetes 组件、软件部署的状态和进度。您可以设置 [集群监控](/docs/rancher2.5/cluster-admin/tools/cluster-monitoring/_index) 或 [项目监控](/docs/rancher2.5/cluster-admin/tools/cluster-monitoring/_index)。
