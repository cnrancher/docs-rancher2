...
请查看 [生产环境清单](/docs/rancher2.5/cluster-provisioning/production/_index) 或 [最佳实践](/docs/rancher2.5/best-practices/_index#tips-for-scaling-and-reliability)，获取下游集群配置的更多最佳实践。
