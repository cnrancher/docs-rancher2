...
更多详情，请参阅[项目管理](/docs/rancher2.5/project-admin/)文档。
...
更多详情，请参阅[多集群应用](/docs/rancher2.5/deploy-across-clusters/multi-cluster-apps/)文档。
...
更多详情，请参阅[应用商店](/docs/rancher2.5/helm-charts/)文档。
...
更多详情，请参阅[配置 Rancher Server URL](/docs/rancher2.5/admin-settings//#配置-rancher-server-url)文档。
...
更多详情，请参阅[RKE 模板](/docs/rancher2.5/admin-settings/rke-templates/)文档。
...
更多详情，请参阅[OPA Gatekeeper](/docs/rancher2.5/cluster-admin/tools/opa-gatekeeper/)文档。
...
更多详情，请参阅[流水线](/docs/rancher2.5/pipelines/)文档。

### 告警

为了保证集群和应用程序的健康，提高组织的生产力，您需要随时了解集群和项目里计划内和计划外发生的事件。发生事件时，将触发您的告警，并向您发送通知。然后，您可以根据需要采取应对措施。

通知和告警功能是基于 [Prometheus Alertmanager](https://prometheus.io/docs/alerting/alertmanager/) 的。利用这些工具，Rancher 可以通知[集群所有者](/docs/rancher2.5/admin-settings/rbac/cluster-project-roles/)和[项目所有者](/docs/rancher2.5/admin-settings/rbac/cluster-project-roles/)有需要处理的告警。

在接收告警之前，必须在 Rancher 中配置一个或多个通知接收者。

创建集群时，Rancher 已经配置了一些内置的告警规则。为它们配置[接收者](/docs/rancher2.5/cluster-admin/tools/notifiers/)后就能收到相应告警。

更多详情，请参阅[告警](/docs/rancher2.5/cluster-admin/tools/cluster-alerts/)文档。
...
关于更多集群日志详情，请参阅[集群日志](/docs/rancher2.5/logging/)文档，项目日志请参阅[项目日志](/docs/rancher2.5/logging/)文档

### 监控

通过 Rancher 您可以使用先进的开源监控解决方案[Prometheus](https://prometheus.io/)来监控集群节点，Kubernetes 组件和软件部署的状态和过程。

关于更多集群监控详情，请参阅[集群监控](/docs/rancher2.5/cluster-admin/tools/cluster-monitoring/)文档，项目监控请参阅[项目监控](/docs/rancher2.5/cluster-admin/tools/cluster-monitoring/)文档
...
更多详情，请参阅[通知](/docs/rancher2.5/cluster-admin/tools/notifiers/)文档。
