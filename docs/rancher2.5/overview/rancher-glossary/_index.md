...
更多详情，请参阅[项目管理](/docs/rancher2.5/project-admin/_index)文档。
...
更多详情，请参阅[多集群应用](/docs/rancher2.5/deploy-across-clusters/multi-cluster-apps/_index)文档。
...
更多详情，请参阅[应用商店](/docs/rancher2.5/helm-charts/_index)文档。
...
更多详情，请参阅[配置 Rancher Server URL](/docs/rancher2.5/admin-settings/_index/#配置-rancher-server-url)文档。
...
更多详情，请参阅[RKE 模板](/docs/rancher2.5/admin-settings/rke-templates/_index)文档。
...
更多详情，请参阅[OPA Gatekeeper](/docs/rancher2.5/cluster-admin/tools/opa-gatekeeper/_index)文档。
...
更多详情，请参阅[流水线](/docs/rancher2.5/pipelines/_index)文档。
...
创建集群时，Rancher 已经配置了一些内置的告警规则。为它们配置[接收者](/docs/rancher2.5/cluster-admin/tools/notifiers/_index)后就能收到相应告警。

更多详情，请参阅[告警](/docs/rancher2.5/cluster-admin/tools/cluster-alerts/_index)文档。
...
关于更多集群日志详情，请参阅[集群日志](/docs/rancher2.5/logging/_index)文档，项目日志请参阅[项目日志](/docs/rancher2.5/logging/_index)文档

### 监控

通过 Rancher 您可以使用先进的开源监控解决方案[Prometheus](https://prometheus.io/)来监控集群节点，Kubernetes 组件和软件部署的状态和过程。

关于更多集群监控详情，请参阅[集群监控](/docs/rancher2.5/cluster-admin/tools/cluster-monitoring/_index)文档，项目监控请参阅[项目监控](/docs/rancher2.5/cluster-admin/tools/cluster-monitoring/_index)文档
...
更多详情，请参阅[通知](/docs/rancher2.5/cluster-admin/tools/notifiers/_index)文档。
