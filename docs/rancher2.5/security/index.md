...
安全是 Rancher 全部功能的基础。Rancher 集成了全部的主流认证工具和服务，并且提供了企业级的[RBAC 能力](/docs/rancher2.5/admin-settings/rbac/)，这些都可以让您的 Kubernetes 集群更安全。
...
- [Kubernetes 安全最佳实践](#kubernetes-安全最佳实践)
...
基准提供两种类型的建议：Automated 和 Manual。我们仅运行 Automated 相关的测试。

当 Rancher 对一个集群进行 CIS 安全扫描时，它会生成一个展示每个测试结果的报告。报告中包括`通过`，`跳过`和`失败`的测试数量的汇总。报告中同时也给`失败`的测试提供了补救办法。

更多详情，请参阅[安全扫描](/docs/rancher2.5/security/security-scan/)文档。
...
我们提供了两个 RPM（红帽软件包），使 Rancher 产品能够在支持 SELinux 的主机上正常运行。`rancher-selinux`和`rke2-selinux`。详情请见[本页](/docs/rancher2.5/security/selinux/)。
...
| :------------------------------------------------------------------------------------ | :-------------------- | :------------------------ | :------------------------------- |
| [加固指南 v2.4.0](/docs/rancher2/security/rancher-2.4/hardening-2.4/)           | Rancher v2.4.0        | Benchmark v1.5            | Kubernetes v1.15                 |
| [加固指南 v2.3.5](/docs/rancher2/security/rancher-2.3.x/2.3.5/hardening-2.3.5/) | Rancher v2.3.5        | Benchmark v1.5            | Kubernetes v1.15                 |
| [加固指南 v2.3.3](/docs/rancher2/security/rancher-2.3.x/2.3.3/hardening-2.3.3/) | Rancher v2.3.3        | Benchmark v1.4.1          | Kubernetes v1.14, v1.15 和 v1.16 |
| [加固指南 v2.3](/docs/rancher2/security/rancher-2.3.x/2.3.0/hardening-2.3/)     | Rancher v2.3.0-v2.3.2 | Benchmark v1.4.1          | Kubernetes v1.15                 |
| [加固指南 v2.2](/docs/rancher2/security/rancher-2.2/hardening-2.2/)             | Rancher v2.2.x        | Benchmark v1.4.1 和 1.4.0 | Kubernetes v1.13                 |
| [加固指南 v2.1](/docs/rancher2/security/rancher-2.1/hardening-2.1/)             | Rancher v2.1.x        | Benchmark v1.3.0          | Kubernetes v1.11                 |
...
| :------------------------------------------------------------------------------------ | :------------------- | :-------------- | :--------------- | :------------------------ |
| [自测指南 v2.4](/docs/rancher2/security/rancher-2.4/benchmark-2.4/)             | Rancher v2.4         | 加固指南 v2.4   | Kubernetes v1.15 | 安全标准 v1.5.0           |
| [自测指南 v2.3.5](/docs/rancher2/security/rancher-2.3.x/2.3.5/benchmark-2.3.5/) | Rancher v2.3.5       | 加固指南 v2.3.5 | Kubernetes v1.15 | 安全标准 v1.5.0           |
| [自测指南 v2.3.3](/docs/rancher2/security/rancher-2.3.x/2.3.3/benchmark-2.3.3/) | Rancher v2.3.3       | 加固指南 v2.3.3 | Kubernetes v1.16 | 安全标准 v1.4.1           |
| [自测指南 v2.3](/docs/rancher2/security/rancher-2.3.x/2.3.0/benchmark-2.3/)     | Rancher v2.3.0-2.3.2 | 加固指南 v2.3   | Kubernetes v1.15 | 安全标准 v1.4.1           |
| [自测指南 v2.2](/docs/rancher2/security/rancher-2.2/benchmark-2.2/)             | Rancher v2.2.x       | 加固指南 v2.2   | Kubernetes v1.13 | 安全标准 v1.4.0 和 v1.4.1 |
| [自测指南 v2.1](/docs/rancher2/security/rancher-2.1/benchmark-2.1/)             | Rancher v2.1.x       | 加固指南 v2.1   | Kubernetes v1.11 | 安全标准 1.3.0            |
...
Rancher 致力于向社区披露我们产品的安全问题。Rancher 将对修复的问题通过发布 CVEs(通用漏洞披露，Common Vulnerabilities and Exposures)通知社区，详情请查看[安全漏洞和解决方法](/docs/rancher2.5/security/cve/)。

## Kubernetes 安全最佳实践

有关保护 Kubernetes 集群的建议，请参阅 [最佳实践](/docs/rancher2.5/security/best-practices/) 指南。
