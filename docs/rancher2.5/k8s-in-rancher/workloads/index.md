...
- [部署工作负载](/docs/rancher2.5/k8s-in-rancher/workloads/deploy-workloads/)
- [升级工作负载](/docs/rancher2.5/k8s-in-rancher/workloads/upgrade-workloads/)
- [回滚工作负载](/docs/rancher2.5/k8s-in-rancher/workloads/rollback-workloads/)
