...
安装 Rancher 时，您可以启用以下几个[高级选项](/docs/rancher2.5/installation/options/_index)：
...
参考[API 审计日志](/docs/rancher2.5/installation/options/api-audit-log/_index)获取更多信息。
...
参考[TLS 配置](/docs/rancher2.5/installation/options/tls-settings/_index)查看更多信息和参数。
