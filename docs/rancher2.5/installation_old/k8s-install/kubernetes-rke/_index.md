...
>
> 要为大规模 Rancher 安装 etcd 集群，请参阅[etcd 设置指南](/docs/rancher2.5/installation/options/etcd/_index)。
...
请参阅[故障排查](/docs/rancher2.5/installation/options/troubleshooting/_index)页面。

## [下一步：安装 Rancher](/docs/rancher2.5/installation/k8s-install/helm-rancher/_index)
