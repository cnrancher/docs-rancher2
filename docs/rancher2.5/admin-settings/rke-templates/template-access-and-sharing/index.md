...
创建模板的用户，则会自动成为该模板的所有者。模板所有者可以将更新模板的权限开放给其他用户，可以与其他用户共享模板的所有权。有关所有者如何修改模板的详细信息，请参阅[有关修改模板的文档](/docs/rancher2.5/admin-settings/rke-templates/creating-and-revising/)。
