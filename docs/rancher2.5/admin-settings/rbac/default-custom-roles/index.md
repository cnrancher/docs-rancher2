...
- [系统管理员权限](/docs/rancher2.5/admin-settings/rbac/global-permissions/)。
- 分配了 [Manage Roles](/docs/rancher2.5/admin-settings/rbac/global-permissions/) 角色的[自定义全局权限](/docs/rancher2.5/admin-settings/rbac/global-permissions/)。
...
4. 选择是否将角色设置为[已锁定](/docs/rancher2.5/admin-settings/rbac/locked-roles/)。
