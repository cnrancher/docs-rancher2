...
- [1. 为 Rancher 配置 AD FS](/docs/rancher2.5/admin-settings/authentication/microsoft-adfs/microsoft-adfs-setup/_index)
- [2. 配置 Rancher 使用 AD FS](/docs/rancher2.5/admin-settings/authentication/microsoft-adfs/rancher-adfs-setup/_index)

## 后续操作

[为 Rancher 配置 Microsoft AD FS](/docs/rancher2.5/admin-settings/authentication/microsoft-adfs/microsoft-adfs-setup/_index)
