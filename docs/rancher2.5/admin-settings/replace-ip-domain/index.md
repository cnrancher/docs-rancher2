...
2. 执行域名变更或 IP 变更之前，请备份 Rancher Server，详情请参考[备份和恢复](/docs/rancher2.5/backups/)。
...
> 注意：操作前先备份，[备份和恢复](/docs/rancher2.5/backups/)。
