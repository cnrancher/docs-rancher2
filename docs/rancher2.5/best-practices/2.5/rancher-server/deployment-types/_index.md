...
如果您在 vSphere 环境中安装 Rancher，请参考[这里](/docs/rancher2.5/best-practices/2.5/rancher-server/rancher-in-vsphere/_index)的最佳实践。
...
Rancher 服务器的 Kubernetes 集群应该尽可能满足[系统和硬件要求](/docs/rancher2.5/installation_new/requirements/_index)。你越是偏离系统和硬件要求，你所承担的风险就越大。
...
在集群中[启用监控](/docs/rancher2.5/monitoring-alerting/2.0-2.4/cluster-monitoring/_index)后，可以设置[通知](/docs/rancher2.5/monitoring-alerting/2.0-2.4/notifiers/_index)和[告警](/docs/rancher2.5/monitoring-alerting/2.0-2.4/cluster-alerts/_index)来让您知道您的集群是否接近其容量。您还可以使用 Prometheus 和 Grafana 监控框架，在您扩展时建立关键指标的基线。
