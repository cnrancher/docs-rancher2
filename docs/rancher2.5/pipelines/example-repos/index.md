...
> **注意:** 示例代码库仅在您[对接版本管理工具](/docs/rancher2.5/project-admin/pipelines/)之前可用。
...
有关为代码库设置自己的流水线的详细信息，请查阅[对接版本管理工具](/docs/rancher2.5/project-admin/pipelines/)，[配置代码库](#配置代码库)和[配置流水线](/docs/rancher2.5/pipelines/)相关的文档。
