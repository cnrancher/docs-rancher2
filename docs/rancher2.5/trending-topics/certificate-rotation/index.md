...
- kubelet（服务证书，如果[启用](/docs/rke/config-options/services/#kubelet-选项))
- kube-apiserver
- kube-proxy
- kube-scheduler
...
> **注意** 如果以前是通过`rke v0.2.0`之前的版本创建的 Kubernetes 集群，在轮换证书前先执行`rke up`操作，参考[证书管理](/docs/rke/cert-mgmt/)
