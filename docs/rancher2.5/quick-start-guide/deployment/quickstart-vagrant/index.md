...
1. 完成初始化后，打开浏览器，执行`https://192.168.56.101`，访问 Rancher UI。
...
完成安装 Rancher Server 和 Kubernetes 集群的步骤后，您可以使用 Rancher 部署工作负载，详情请参考[部署工作负载](/docs/rancher2.5/quick-start-guide/workload/)。
