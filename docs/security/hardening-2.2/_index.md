---
title: 安全加固指南 - v2.2
description: 本文提供了加固 Rancher v2.1.x 的操作指导，您可以参考本文，加固您的 Rancher，使您的集群符合互联网安全中心发布的 Kubernetes 安全基准，保护集群中节点的安全。建议您在安装 Kubernetes 前按照本指南进行操作。
keywords:
  - rancher 2.0中文文档
  - rancher 2.x 中文文档
  - rancher中文
...
本文提供了加固 Rancher v2.2.x 的操作指导，您可以参考本文，加固您的 Rancher，使您的集群符合互联网安全中心发布的 Kubernetes 安全基准，保护集群中节点的安全。建议您在安装 Kubernetes 前按照本指南进行操作。
...
下面的安全加固指南是针对在生产环境的 Rancher v2.2.x 中使用 Kubernetes 1.13 版本的集群。它概述了如何满足互联网安全中心（简称 CIS）提出的 Kubernetes 安全标准。
