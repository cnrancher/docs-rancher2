---
title: 创建K3d集群
description: 本文介绍了如何使用 K3d 在宿主句中使用 Docker 初始化 K3s 集群，以及为已有的 K3s 集群添加节点的操作步骤。
keywords:
  - k3s中文文档
  - k3s 中文文档
  - k3s中文
...
本文介绍了如何使用 K3d 在宿主句中使用 Docker 初始化 K3s 集群，以及为已有的 K3s 集群添加节点的操作步骤。除此之外，本文还提供了在 K3d 上运行 AutoK3s 的进阶操作指导，如配置私有镜像仓库。
...
| Network | 使用已经存在的 [Docker 网络](https://k3d.io/internals/networking/) |
...
| Registry | 私有镜像仓库配置文件路径，如果您的私有镜像仓库带有证书，请参考[这里](https://k3d.io/usage/guides/registries/#secure-registries) | 
...
私有镜像仓库配置仅作用于 k3s v0.10.0 及以上版本，带认证的私有镜像仓库需要将 TLS 文件挂载到 K3d 容器中，更多的信息请查看[这里](https://k3d.io/usage/guides/registries/#secure-registries)。
