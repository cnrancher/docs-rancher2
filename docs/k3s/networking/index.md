...
关于 Flannel 配置选项和后端选择的细节，或如何设置自己的 CNI，请参考[安装网络选项](/docs/k3s/installation/network-options/)页面。

关于 K3s 需要开放哪些端口，请参考[安装要求](/docs/k3s/installation/installation-requirements/#网络)。
