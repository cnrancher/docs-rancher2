            ...
            <header className={classnames("hero", styles.heroBanner)}>
                <div className="container">
                    ...
                    <div className="text-xs text-gray">
                        Rancher帮助企业能够在生产环境中运行和管理Docker和Kubernetes，而无需从头开始构建容器服务平台。Rancher不再维护1.x版本的文档，建议您升级至2.x后，配合2.x文档使用新版Rancher。在任何页面，您都可以点击左上角的logo回到本页。想要下载离线文档，请点击导航栏中的“获取
                        PDF 文档”。
                    </div>
                </div>
            </header>
