...
function getToc(sidebars, metadata, baseUrl) {
    ...
    Object.keys(docs).forEach((categoryKey) => {
        ...
        const description = metadata.categories.rke2[categoryKey];
        if (description) {
            out.push({
                key: categoryKey,
                description,
